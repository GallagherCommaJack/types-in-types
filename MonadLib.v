...
Local Obligation Tactic := program_simpl; match goal with [xs: list _|-_] => induction xs; simpl; f_equal; auto end.
Program Instance list_functor : Functor list := { fmap := List.map }.
Local Hint Resolve List.concat_map List.concat_app List.app_nil_r.
Hint Rewrite List.concat_map List.concat_app List.app_nil_r.

Local Obligation Tactic := program_simpl; 
    match goal with [xs: list _|-_] => induction xs; simpl; autorewrite with core; f_equal; auto end.
